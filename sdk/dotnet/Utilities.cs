...
namespace Pulumi.Ipidp
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://yyyy.xxxxx.io/artifactory/sp-docker/pulumi-ipidp-provider";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ipidp.version.txt");
    ...
    internal sealed class IpidpResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public IpidpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
