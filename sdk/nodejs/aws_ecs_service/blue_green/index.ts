...
// Export members:
export { CodeDeployArgs } from "./codeDeploy";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ipidp:aws_ecs_service/blue_green:CodeDeploy":
...
pulumi.runtime.registerResourceModule("ipidp", "aws_ecs_service/blue_green", _module)
